...
function App() {
  ...
  function handleSelectFriend(friend) {
    setSelectedFriend((currSelect) => currSelect?.id === friend.id ? null: friend);
    setShowAddFriend(false);
  }
...
function AddFriendForm({ onAddFriend }) {
  ...
  // submit function is called with event object
...
function SplitBillForm({ friendName, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input 
        ...
        value={paidByUser}
        onChange={(e) => 
          setPaidByUser( // do not update if the nb is greater that the bill
